...
from sqlalchemy import BigInteger, Column, DateTime, String, ForeginKey
...
class OrderDetailMixin:
    ...
    order_id = Column(BigInteger, ForeginKey("order.id"), nullable=False)
    product_id = Column(BigInteger, ForeginKey("product.id"), nullable=False)
