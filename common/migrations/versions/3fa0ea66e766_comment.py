...
def upgrade() -> None:
    ...
    sa.Column('post_code', sa.String(length=10), nullable=False, comment='ユーザー郵便番号'),
    sa.Column('user_address1', sa.String(length=255), nullable=False, comment='ユーザー住所1'),
    sa.Column('user_address2', sa.String(length=255), nullable=False, comment='ユーザー住所2'),
    sa.Column('user_tel', sa.String(length=15), nullable=False, comment='ユーザー電話番号'),
    sa.Column('user_email', sa.String(length=255), nullable=False, comment='ユーザーメールアドレス'),
    sa.Column('user_name', sa.String(length=255), nullable=False, comment='ユーザー名'),
    sa.Column('shipping_post_code', sa.String(length=10), nullable=False, comment='配送先郵便番号'),
    sa.Column('shipping_user_address1', sa.String(length=255), nullable=False, comment='配送先ユーザー住所1'),
    sa.Column('shipping_user_address2', sa.String(length=255), nullable=False, comment='配送先ユーザー住所2'),
    sa.Column('shipping_user_tel', sa.String(length=15), nullable=False, comment='配送先ユーザー電話番号'),
    sa.Column('shipping_user_email', sa.String(length=255), nullable=False, comment='配送先ユーザーメールアドレス'),
    sa.Column('shipping_user_name', sa.String(length=255), nullable=False, comment='配送先ユーザー名'),
    ...
    sa.Column('product_code', sa.String(length=255), nullable=False, comment='商品コード'),
    ...
    sa.Column('product_percent_tax', sa.String(length=255), nullable=False, comment='税率'),
